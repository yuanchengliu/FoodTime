...
public class OfficialService extends ServiceImpl<OfficialMapper, Official> implements IOfficialService {
     ...
     */
    @Override
    public CommonPage<OfficialDTO> getOfficial(Integer pageNum, Integer pageSize, String searchResults){
        Page<Official> page = new Page<>(pageNum,pageSize);
        QueryWrapper<Official> wrapper = new QueryWrapper<>();
        wrapper.lambda().like(Official::getAddress, searchResults);
    ...
    @Override
    public CommonPage<AddressDTO> seleAllAddress(Integer pageNum, Integer pageSize, String searchResults){
        Page<Address> page = new Page<>(pageNum,pageSize);
        QueryWrapper<Address> wrapper = new QueryWrapper<>();
        wrapper.lambda().like(Address::getAid,searchResults);
